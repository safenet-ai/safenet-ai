...
class _NewServiceRequestpage extends State<NewServiceRequestpage> {
  ...
  Future<String> _generateServiceId() async {
    final counterRef =
        FirebaseFirestore.instance.collection('counters').doc('services');
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(color: Colors.black.withOpacity(0.06), blurRadius: 8, offset: const Offset(4, 4)),
          ],
        ),
        child: Row(
          children: [
                ...
                children: [
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: selectedWorker != null
                                  ? (selectedWorker!['avatarColor'] as Color).withOpacity(0.95)
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  selectedWorker != null ? selectedWorker!['name'] : "Select Worker",
                                  style: TextStyle(
                                    fontSize: 16,
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        mainAxisSize: MainAxisSize.min,   // <<< THIS makes it compact
                        children: const [
