...
import '../../resident/pages/resident_dashboard.dart';
...
class _SafeNetLoginPageState extends State<ResidentLoginPage> {
  ...
  Future<void> _showForgotPasswordDialog() async {
    // Pre-fill with email if the user already typed one
    final prefill = _loginCtrl.text.contains('@') ? _loginCtrl.text.trim() : '';
